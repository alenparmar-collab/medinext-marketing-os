-- ---------------------------------------------------------------------------
-- MUTATION: definer without the gate.
--
-- Completeness bought by letting anybody read anybody's numbers. The figures
-- become correct and the privacy disappears, which is the wrong trade and the
-- reason the gate is written out explicitly rather than inherited from RLS.
-- ---------------------------------------------------------------------------
